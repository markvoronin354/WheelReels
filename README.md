...
- **`MediaButtonService`**: Foreground service holding `MediaSession` to capture Bluetooth AVRCP commands from car head units and monitor target apps via `UsageStatsManager`.
